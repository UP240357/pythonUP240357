...
#2. declarar mi altura
height = (1.70)

#3. declarar un numero comlejo
Complejo = 1+4j
...
#6. area y perimetro de un rectangulo
...
#7. area y circunferencia de un circulo
...
#8. Intersecciones de X y Y en y = 2x - 2
...
#9. encontrar pendiente y distancia eucladiana
print("Pendiente")
x1,y1 = 2, 2
x2,y2 = 6,10
m_2 = (y2-y1)/(x2-x1)
...
#11. calcular el valor de y en (y= x^2 + 6x + 9)
...
#12. longitud y comparacion falsa de "python" y "dragon"
...
#13. busqueda de la palbra "on" en las dos palabras
...
#14. buscar "jargon" en una sentencia
...
#15. busqueda de la palbra "on" no debe estar en las dos palabras
...
#16. longitud de la palabra python y hacerla string
...
#18. floor division 7/3 igual a int 2.7
...
#21. calcula el pago por horas de una persona
...
#22. segundos que ha vivido una persona basada en los años introducidos
...
#23. tabla dada por la instruccion
